        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">Koza Matbaa</h3>
                <p className="text-sm text-gray-400">Kaliteli Baskı Hizmetleri</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6">
              25 yılı aşkın deneyimimizle matbaa sektöründe güvenilir bir partner olarak 
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="bg-gray-800 hover:bg-orange-500 text-white p-3 rounded-lg transition-all duration-300 transform hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service, index) => (
                <li key={index}>
                  <span className="text-gray-300 hover:text-orange-400 transition-colors duration-300 cursor-pointer">
                    {service}
                  </span>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  href="mailto:info@kozamatbaa.com"
                  className="text-gray-300 hover:text-orange-400 transition-colors duration-300"
                >
                  info@kozamatbaa.com
                </a>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} Koza Matbaa. Tüm hakları saklıdır.
            </div>
